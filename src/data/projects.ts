export const projects = [
  {
    title: 'FrankChatOn',
    description: 'Chat App is a real-time chat application built with Node.js, Express, and Socket.IO. It allows users to join chat rooms, send messages, and share their locations with other users in real-time. The application features a modern and responsive design, making it easy to use on both desktop and mobile devices.',
    thumbnail: 'https://github.com/SouravFrank/FrankChatOn/blob/master/localhost_8080_room.png?raw=true',
    githubLink: 'https://github.com/SouravFrank/FrankChatOn',
  },
  {
    ...
    githubLink: 'https://github.com/SouravFrank/Wishnet-Usage-Tracker',
  },
  {
  ...
  },
  {
    ...
    thumbnail: 'https://github.com/SouravFrank/AudioGrabber/blob/main/images/Screenshot.png?raw=true',
    githubLink: 'https://github.com/SouravFrank/AudioGrabber',
  },
];
