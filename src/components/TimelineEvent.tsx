...
import { Briefcase, GraduationCap, Award, BookOpen, Cake } from 'lucide-react';
...
export default function TimelineEvent({ title, location, date, icon, type, highlights, index }: TimelineEventProps) {
