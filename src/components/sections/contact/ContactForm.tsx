...
const useDummyEmail = true; // Flag to toggle between dummy and actual email sending
      ...
      >
          ...
          <div className="relative">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full p-4 pl-12 rounded-lg bg-gray-50 dark:bg-gray-700/50 border ${errors.includes("Your name is required.") ? 'border-red-500' : 'border-gray-200'} dark:border-gray-600 focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent outline-none transition-all duration-200`}
          ...
          <div className="relative">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full p-4 pl-12 rounded-lg bg-gray-50 dark:bg-gray-700/50 border ${errors.includes("Your email is required.") ? 'border-red-500' : 'border-gray-200'} dark:border-gray-600 focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent outline-none transition-all duration-200`}
        ...
        <div className="md:col-span-2 space-y-4 flex flex-col items-end">
          <CTAButton 
            ...
            variant="colored"
            Icon={Send}
            downloadClicked={status === 'success'}
          />
